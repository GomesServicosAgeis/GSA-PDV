...
export default function Registrar() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Criando o usuário no Supabase Auth
    ...
    if (error) {
      ...
      alert('Conta GSA criada com sucesso! Redirecionando para o login...')
      router.push('/login')
    }
  }
  ...
  return (
    <main className="h-screen flex items-center justify-center bg-gray-950 font-sans p-4">
      <form onSubmit={handleRegister} className="bg-gray-900 p-8 md:p-10 rounded-3xl border border-gray-800 shadow-2xl w-full max-w-md">
        ...
        <p className="text-gray-500 text-center mb-8 font-bold text-xs uppercase tracking-widest italic">Crie sua conta de lojista</p>
        ...
        <div className="space-y-4">
          ...
          <div className="text-center mt-6">
            <Link href="/login" className="text-gray-500 hover:text-white text-xs font-bold uppercase transition-colors">
